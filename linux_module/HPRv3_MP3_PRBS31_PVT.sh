...
MP3_Function_PRBS31_test()
{
	record_time "$session" start "PRBS31 Test;NA" "NA" "NA" "${RackSN}"
    	...
    	./prbs31_log_parser.sh -t PVT -p 129 -f ${PRBS31ResultLog}
...
if [ "${PIPESTATUS[0]}" -ne "0" ];then
   ...
   finalLog=${RackIPN}_${RackSN}_${RackAsset}_HPRv3_MP3_${index}_${sw_sn}_PRBS31_FAIL_${startTime}.log
...
finalLog=${RackIPN}_${RackSN}_${RackAsset}_HPRv3_MP3_${index}_${sw_sn}_PRBS31_PASS_${startTime}.log
cat ${LOGFILE} > ${LOGPATH}/${RackSN}/FSW/${index}/${finalLog}
