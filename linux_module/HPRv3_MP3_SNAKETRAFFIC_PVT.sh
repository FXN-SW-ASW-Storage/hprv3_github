...
MP3_Function_Snake_Traffic_test()
{
    ...
    executeCMDinDiagOS "cd /usr/local/cls_diag/SDK;./bcm.user -y Minipack3_128x400_DVT.config.yml" "$sw_ip" "traffictest 1-6,9-14,17-22,25-30,33-38,41-46,49-54,57-62 600;sleep 30;portdump counters 1-6,9-14,17-22,25-30,33-38,41-46,49-54,57-62" "${sw_ip}" | tee ${SnakeTrafficResultLog}
    flg=0
    ...
    for port in {1..6} {9..14} {17..22} {25..30} {33..38} {41..46} {49..54} {57..62}
    do
...
if [ "${PIPESTATUS[0]}" -ne "0" ];then
    ...
    finalLog=${RackIPN}_${RackSN}_${RackAsset}_HPRv3_MP3_${index}_${sw_sn}_SNAKETRAFFIC_FAIL_${startTime}.log
...
finalLog=${RackIPN}_${RackSN}_${RackAsset}_HPRv3_MP3_${index}_${sw_sn}_SNAKETRAFFIC_PASS_${startTime}.log
cat ${LOGFILE} > ${LOGPATH}/${RackSN}/FSW/$index/${finalLog}
cp ${LOGPATH}/${RackSN}/FSW/$index/${finalLog} /log/hprv3 > /dev/null
