...
get_test_item(){
     ...
     #test_item="chk_fsw_ip mp2_test mp2_initial mp2_prbs31  mp2_snake_traffic mp2_insertion_loss"
         test_item="Standlone_split_rackinf chk_rusw_ip HPRv3_BMC_Function HPRv3_PMM_Standalone HPRv3_PSU_Standalone HPRv3_BBU_Standalone"
     elif [ $execfunction == "functional" ];then
     #test_item="chk_fsw_ip mp2_test mp2_initial mp2_prbs31  mp2_snake_traffic mp2_insertion_loss"
         #test_item="chk_rusw_ip run_wedge400_test"
        test_item="Standlone_split_rackinf chk_rusw_ip HPRv3_WG400BMC_Function run_wedge400_test HPRv3_PMM_Standalone HPRv3_PSU_Standalone HPRv3_BBU_Standalone HPRv3_PSU_Function_Full HPRv3_BBU_Function_Full HPRv3_PMM_Function_Full HPRv3_ACLoss_Function"
    else
