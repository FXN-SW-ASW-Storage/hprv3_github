...
MP3_Function_Diagnostic_test()
{
    ...
    FRUInfo=("Magic Word" "Format Version" "Product Name" "Product Part Number" "System Assembly Part Number" "Meta PCBA Part Number" "Meta PCB Part Number" "ODM/JDM PCBA Part Number" "ODM/JDM PCBA Serial Number" "PCBA Part Number" "Product Version" "Product Sub-Version" "Product Serial Number" "System Manufacturer" "System Manufacturing Date" "PCB Manufacturer" "Assembled at" "EEPROM location on Fabric" "CRC16") 

    SCMFRUInfo=("Magic Word" "Format Version" "Product Name" "Product Part Number" "System Assembly Part Number" "Meta PCBA Part Number" "Meta PCB Part Number" "ODM/JDM PCBA Part Number" "ODM/JDM PCBA Serial Number" "PCBA Part Number" "Product Version" "Product Sub-Version" "Product Serial Number" "System Manufacturer" "System Manufacturing Date" "PCB Manufacturer" "Assembled at" "EEPROM location on Fabric" "X86 CPU MAC Base" "X86 CPU MAC Address Size" "CRC16") 
    ...
    SMBFRU_DATA=("0xFBFB" "0x[5-6]" "MINIPACK3_SMB" "20100187" "" "132100093" "131100033" "R3214G000304" "A[0-9]{12}" "[2-3]" "[2-4]" "20" "M[0-9]{12}" "CLS" "202[4-5](0[1-9]|1[0-2])(0[1-9]|[12][0-9]|3[01])" "WUS" "CTH" "SMB" "0x[0-9a-z]+")
    ...
    SCMFRU_DATA=("0xFBFB" "0x[5-6]" "MINIPACK3_SCM" "20100188" "" "132100049" "131100035" "4" "A[0-9]{12}" "[2-4]" "[2-4]" "10" "M[0-9]{12}" "CLS" "202[4-5](0[1-9]|1[0-2])(0[1-9]|[12][0-9]|3[01])" "ZFP" "CTH" "SCM" "[0-9a-f]{2}:[0-9a-f]{2}:[0-9a-f]{2}:[0-9a-f]{2}:[0-9a-f]{2}:[0-9a-f]{2}" "1" "0x[0-9a-z]+")
    ...
    for i in "${!FRUInfo[@]}"; do
        ...
        if [ "${FRUInfo[$i]}" == "ODM/JDM PCBA Serial Number" ]  || [ "${FRUInfo[$i]}" == "System Manufacturing Date" ] || [ "${FRUInfo[$i]}" == "CRC16" ] || [ "${FRUInfo[$i]}" == "Format Version" ] || [ "${FRUInfo[$i]}" == "PCBA Part Number" ] || [ "${FRUInfo[$i]}" == "Product Version" ];then
    ...
    for i in "${!FRUInfo[@]}"; do
        ...
        if [ "${FRUInfo[$i]}" == "ODM/JDM PCBA Serial Number" ] || [ "${FRUInfo[$i]}" == "Product Serial Number" ] || [ "${FRUInfo[$i]}" == "System Manufacturing Date" ] || [ "${FRUInfo[$i]}" == "CRC16" ] || [ "${FRUInfo[$i]}" == "Format Version" ] || [ "${FRUInfo[$i]}" == "PCBA Part Number" ]|| [ "${FRUInfo[$i]}" == "Product Version" ];then
            logResultCheck "CheckEGREPFormat" "${FRUInfo[$i]}" "NF;${FRU_FinalArr[$i]}" "${diagnosticLog}"
            if [ ${PIPESTATUS[0]} -ne 0 ];then
		echo "Select another FRU data to check again"
    ...
    for i in "${!SCMFRUInfo[@]}"; do
        ...
        if [ "${SCMFRUInfo[$i]}" == "ODM/JDM PCBA Serial Number" ] || [ "${SCMFRUInfo[$i]}" == "Product Serial Number" ] || [ "${SCMFRUInfo[$i]}" == "System Manufacturing Date" ] || [ "${SCMFRUInfo[$i]}" == "X86 CPU MAC Base" ] || [ "${SCMFRUInfo[$i]}" == "X86 CPU MAC Address Size" ] || [ "${SCMFRUInfo[$i]}" == "CRC16" ] || [ "${SCMFRUInfo[$i]}" == "PCBA Part Number" ] || [ "${SCMFRUInfo[$i]}" == "Product Version" ]|| [ "${SCMFRUInfo[$i]}" == "Format Version" ];then
    ...
    for i in "${!PSUFRUInfo[@]}"; do
        ...
        if [ "${PSUFRUInfo[$i]}" == "ODM/JDM PCBA Serial Number" ] || [ "${PSUFRUInfo[$i]}" == "Product Serial Number" ] || [ "${PSUFRUInfo[$i]}" == "System Manufacturing Date" ] || [ "${PSUFRUInfo[$i]}" == "CRC16" ] || [ "${PSUFRUInfo[$i]}" == "Format Version" ] || [ "${PSUFRUInfo[$i]}" == "PCBA Part Number" ] || [ "${PSUFRUInfo[$i]}" == "Product Version" ];then
