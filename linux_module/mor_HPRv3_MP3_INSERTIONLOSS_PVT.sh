...
MP3_Init_test()
{
    ...
    echo "Command : sshpass -p "0penBmc" scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -r $TOOL/INSERTION_LOSS ${OSIP}:/tmp"
    sshpass -p "0penBmc" sshpass -p "0penBmc" scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -r $TOOL/INSERTION_LOSS ${OSIP}:/tmp
