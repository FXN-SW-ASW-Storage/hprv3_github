...
rack_item="assetid rackipn platform racktype RUSW_Model RUSW_Count FSW_Model FSW_Count powershelf_count"
...
main()
{
	...
	echo "Current Rack Type : ${rackType} and contains FSW"
